...
const customBlocks = [
  {
      ...
      content: `<section className="def-section"></section> <style>.def-section {display: block;min-height: 150px/*inlinestyles*/}</style>`,
  ...
  },
  {
      ...
      content: `<div className="codebg"><h3>Example</h3>&nbsp;&nbsp;
        <style type="text/css">
          .codebg {
            background:#f6f6f6;
            border-radius: 10px;
    ...
    },
    {
      ...
      content: `<div className="drop-text" data-gjs-type="text">Insert your text here</div>
      <style>
    ...
    },
    {
      ...
      content: `<div className="vertical-flex"></div>
      <style>
    ...
    },
    {
      ...
      content: `<div className="Horizontal-flex"></div>
      <style>
    ...
    },
    {
      ...
      content: `<div className="divider-def"></div>
      <style>
    ...
    },
    {
      ...
      content: `<div data-gjs-highlightable="true" id="ik8sh" data-gjs-type="text" draggable="true" className="menu-item gjs-selected link-block" contenteditable="false"><a id="ipep9d" data-gjs-type="link" draggable="true" href="" className="">WEB</a></div>
        <style>
        .link-block{
          position: static;
          display: block;
    ...
    },
    {
      ...
      content: `<div data-gjs-highlightable="true" id="ik8sh" data-gjs-type="text" draggable="true" className="menu-item gjs-selected gjs-button" contenteditable="false"><a id="ipep9d" data-gjs-type="link" draggable="true" href="" className="">Run Code</a></div>
      <style>
        .gjs-button {
    ...
    },
    {
      ...
      content: `<h1 className="gjs-heading1">Heading 1</h1>
      <style>
      .gjs-heading1 {
        margin-top: 0px;
        margin-bottom: 0px;
    ...
    },
    {
      ...
      content: `<h2 className="gjs-heading2">Heading 2</h2>
      <style>
      .gjs-heading2 {
        margin-top: 10px;
        margin-bottom: 10px;
    ...
    },
    {
      ...
      content: `<h3 className="gjs-heading3">Heading 3</h3>
      <style>
      .gjs-heading3 {
        margin-top: 10px;
        margin-bottom: 10px;
    ...
    },
    {
      ...
      content: `<h3 className="gjs-heading4">Heading 4</h3>
      <style>
      .gjs-heading4 {
        margin-top: 10px;
        margin-bottom: 10px;
    ...
    },
    {
      ...
      content: `<h3 className="gjs-heading5">Heading 5</h3>
      <style>
      .gjs-heading5 {
        margin-top: 10px;
        margin-bottom: 10px;
    ...
    },
    {
      ...
      content: `<h3 className="gjs-heading6">Heading 6</h3>
      <style>
      .gjs-heading6 {
        margin-top: 10px;
        margin-bottom: 10px;
    ...
    },
    {
      ...
      content: `<div id="iq5sru" data-gjs-type="video" draggable="true" allowfullscreen="allowfullscreen" className="gjs-selected"></div>`
    },
    {
      id: 'Quote',
      ...
      content: `<blockquote data-gjs-highlightable="true" id="ib6ngh" data-gjs-type="text" draggable="true" className="quote gjs-selected">
