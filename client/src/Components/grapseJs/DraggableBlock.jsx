...
const customBlocks = [
  ...
  },
  {
    ...
    },
    {
      ...
      content: `<div data-gjs-highlightable="true" id="ik8sh" data-gjs-type="text" draggable="true" class="menu-item gjs-selected gjs-button" contenteditable="false"><a id="ipep9d" data-gjs-type="link" draggable="true" href="" class="">Run Code</a></div>
      <style>
        .gjs-button {
