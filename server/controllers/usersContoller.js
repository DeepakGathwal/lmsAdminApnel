...
const { pagination } = require("../utils/pagination");
  ...
  exports.allUsers = catchAsyncError(async(req,res) =>{
    ...
    const query = `Select id,image, name, email,phone, provider,last_login, created_at  from jtc_ecommers_users WHERE deleted_by = '0' ${seletById} ORDER by id desc `
