...
exports.addLinks = catchAsyncError(async(req,res) => {
    ...
    const addNewPoint =  `Insert into jtc_website_links SET page_css = ${css},page_html = ${html}, name = ${name}, nav_link = ${nav_link},explore = ${header}, created_by = ${user}, created_at =  current_timestamp()`
...
exports.editLinks = catchAsyncError(async(req,res) => {
    ...
    const editNewPoint =  `Update jtc_website_links SET name = ${name}, nav_link = ${nav_link},page_css = ${css},page_html = ${html}, updated_by = ${user}, updated_at =  current_timestamp() WHERE id = ${id}`
